...
from encoding.nn import SegmentationLosses_parse as SegmentationLosses
...
class Trainer():
    ...
    def training(self, epoch):
        ...
        for i, (image, target, seg_half, seg_full) in enumerate(tbar):
            ...
            targets = [target, seg_half, seg_full]
